...
(function() {
  define(['jquery'], function($) {
    var accountID, addScript, analytics, debug, init, internalTrafficDomains, isHTTP, isHTTPS, log, root, settings, siteName, track, upon;
    ...
    init = function(options) {
      var $body, domain, fireEngagementAfterSec, hasStarted, idx, isTracked, key, lastPlaybackReportTime, lastReportedPlaybackPercent, pageHeight, playbackReportTimes, scrollY, trackAt, url, windowHeight, _i, _len, _ref;
      for (key in options) {
